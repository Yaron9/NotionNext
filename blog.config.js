...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '25be75235365806290e0ee0b97088537',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '大王分享', // 您的昵称
  BIO: process.env.NEXT_PUBLIC_BIO || '感谢阅读 · 愿这里的内容对你有帮助', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://woozy-capybara-7ae.notion.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, Claude, ChatGPT, 教程, 攻略, 技术分享, 大王分享', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    '欢迎来到大王分享,用 AI 过好每一天,这里有实用的技术教程,也有省钱省时间的攻略',
